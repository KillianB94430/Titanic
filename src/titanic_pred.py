...
# Split responsibilities into smaller functions
# Docstrings
...
# P1 : Load_model prend en argument le nom du modele
# P2 : mneage dans les prints
# P1 : Plus de commentaires
# Dosctring
def load_model():
    client = MlflowClient()
